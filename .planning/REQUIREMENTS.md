...
- [x] **FE-08**: `frontend/.env.local` updated to point `VITE_API_BASE_URL` at the local FastAPI backend during dev, the deployed Alibaba ECS endpoint in production
